...
// #127 job work is not tested here. The stock movement this lane built was grafted onto the
// ITC-04 lane's service at the merge, and its proofs moved with it — see `jobWork.dbtest.ts`.

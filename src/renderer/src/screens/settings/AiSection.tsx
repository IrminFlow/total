...
import { EGRESS_MODES, KEY_MASK, endpointHost, isLocalEndpoint } from '@shared/ai/endpoint'
// Type-only, so the schema it is inferred from is erased at build time rather than shipped.
import type { AiSettings } from '@shared/ai/config'

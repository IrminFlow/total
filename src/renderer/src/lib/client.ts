 ...
 *
 * Spelled out here rather than imported: the engine in @shared/gst/rateHistory names these fields
 * `ratePercent`/`cessPercent`, and this wire shape has always said `rate`/`cessRate`. The service
 * converts; see the note on `ItemRate` in src/main/services/gstRates.ts.
 */

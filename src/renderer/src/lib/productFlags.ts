export type ProductFlagId = "guidedHelp" | "featureDiscovery" | "communityWorkspace";
...
export const PRODUCT_FLAGS: { id: ProductFlagId; label: string; safeFallback: string }[] = [
...
const defaults = (): ProductFlagState => ({
  version: 1,
  flags: { guidedHelp: true, featureDiscovery: true, communityWorkspace: true },
  history: [],
});

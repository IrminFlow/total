...
describe('tally value parsing', () => {
  it('parses amounts, dates and quantities', () => {
    ...
    expect(parseTallyDate('20240229')).toBe('2024-02-29')
    expect(parseTallyDate('20260229')).toBeNull()
    expect(parseTallyDate('20261301')).toBeNull()
    expect(parseTallyDate('20260431')).toBeNull()

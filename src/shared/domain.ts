...
export interface Ledger {
  ...
  address: string | null;
  /** Optional party contact used only for user-initiated document/reminder drafts. */
  email: string | null;
  phone: string | null;
...
export interface BudgetLine {
  ...
  groupId: number | null;
  /** Department, project or branch dimension (cost-centre hierarchy). */
...
export interface Voucher {
  ...
  isOptional: boolean;
  /** Immutable link when this entry reverses another voucher. */
  reversalOfId: number | null;
  reversalReason: string | null;
  reversalAuthor: string | null;
  /** The linked reversal, when this voucher has already been reversed. */
...
export interface PayrollRun {
  ...
  createdAt: string;
  runKind?: "regular" | "supplementary" | "reversal" | "final_settlement";

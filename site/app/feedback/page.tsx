...
export const metadata: Metadata = { title: 'Customer ideas', description: 'Suggest, vote for and follow improvements to Total accounting software.', alternates: { canonical: '/feedback' } }

...
export const metadata: Metadata = { title: 'Local receipt capture', description: 'Capture receipts on your phone and share them to Total without uploading them to an accounting cloud.', alternates: { canonical: '/capture' } }

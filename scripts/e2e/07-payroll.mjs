...
await scenario('07-payroll', async (h) => {
  ...
  await h.page.getByRole('tab', { name: 'Attendance' }).click()
  await h.page.getByText('READY', { exact: true }).waitFor()
  await h.shot('01-payroll-attendance')
  await h.page.getByRole('tab', { name: 'Leave & salary' }).click()
  ...
  await h.page.getByRole('tab', { name: 'Claims' }).click()
  ...
  await h.page.getByRole('tab', { name: 'Contractors' }).click()
  ...
  await h.page.getByRole('tab', { name: 'Controls' }).click()

...
const evidence = {
  ...
  signing: { macIdentityConfigured: !!process.env.MAC_CSC_LINK || !!process.env.CSC_LINK, appleNotarizationConfigured: !!process.env.APPLE_API_KEY, windowsIdentityConfigured: !!process.env.WIN_CSC_LINK },

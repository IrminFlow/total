...
5. Keep the purchased major version, books, reports, backups and portable export usable without an active Care renewal.
6. Require qualified legal review before charging users or beginning significant paid marketing.

## Why this model fits Total
...
- The exact date paid sales open.
- Tax registration and invoice process for licence sales.
- Reseller or marketplace terms.
- Holiday calendar and staffing needed to meet published support targets.
- Whether later encrypted sync is included in Care or sold as a separate subscription.

Engineering must not infer or activate these decisions from product telemetry. Any change to price,
licence scope, refund terms or support targets requires a new dated policy and approval digest.
